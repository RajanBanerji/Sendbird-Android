package com.example.testappsyncmanager.member;
...
import com.example.testappsyncmanager.adapters.UserListAdapter;
import com.example.testappsyncmanager.connection.ChatConnectionManager;
import com.example.testappsyncmanager.ui.groupchat.CloseGroupChatActivity;
...
public class MemberListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mChannelUrl = getIntent().getStringExtra(CloseGroupChatActivity.EXTRA_CHANNEL_URL);
